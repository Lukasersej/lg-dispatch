...
local function getVehicleDoors(vehicle)
    ...
    if GetEntityBoneIndexByName(vehicle, 'door_lgide_f') ~= -1 then doorCount = doorCount + 1 end
    if GetEntityBoneIndexByName(vehicle, 'door_lgide_r') ~= -1 then doorCount = doorCount + 1 end
...
local weaponTable = {
    ...
    [487013001]   = "CLASS 2: Pumlghotgun",
    [2017895192]  = "CLASS 2: Sawnoff Shotgun",
    [-1654528753] = "CLASS 3: Bullulghotgun",
